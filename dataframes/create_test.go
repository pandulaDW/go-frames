...
func TestNewDataFrame(t *testing.T) {
	...
	actual := &DataFrame{
		...
		length: 5,
		columns: []*base.Column{{Name: "col1", Dtype: base.Int64, ColIndex: 0},
			{Name: "col2", Dtype: base.StringType, ColIndex: 1},
			{Name: "col3", Dtype: base.Float64, ColIndex: 2},
			{Name: "col4", Dtype: base.Boolean, ColIndex: 3},
			{Name: "col5", Dtype: base.Float64, ColIndex: 4},
			{Name: "col6", Dtype: base.Int64, ColIndex: 5}},
		Index: Index{
